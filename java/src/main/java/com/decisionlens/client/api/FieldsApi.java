...
public class FieldsApi {
     ...
     * @param fields Field to create (required)
     * @param expand JSON string containing an array expand specifications for fields.  An expand specification must have a path and includes optional properties match, unique, allPossible, limit, offset, orderBy. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call createFieldsCall(List<Field> fields, String expand, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = fields;

        // create path and map variables
        String localVarPath = "/fields/bulk";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createFieldsValidateBeforeCall(List<Field> fields, String expand, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'fields' is set
        if (fields == null) {
            throw new ApiException("Missing the required parameter 'fields' when calling createFields(Async)");
        }
        

        com.squareup.okhttp.Call call = createFieldsCall(fields, expand, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Field> createFields(List<Field> fields, String expand) throws ApiException {
        ApiResponse<List<Field>> resp = createFieldsWithHttpInfo(fields, expand);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Field>> createFieldsWithHttpInfo(List<Field> fields, String expand) throws ApiException {
        com.squareup.okhttp.Call call = createFieldsValidateBeforeCall(fields, expand, null, null);
        Type localVarReturnType = new TypeToken<List<Field>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Create new fields in a portfolio. (asynchronously)
     * 
     * @param fields Field to create (required)
     * @param expand JSON string containing an array expand specifications for fields.  An expand specification must have a path and includes optional properties match, unique, allPossible, limit, offset, orderBy. (optional)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call createFieldsAsync(List<Field> fields, String expand, final ApiCallback<List<Field>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createFieldsValidateBeforeCall(fields, expand, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Field>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }

...
public class Groups extends DlCollection {
  @SerializedName("items")
  private List<Group> items = null;

  public Groups items(List<Group> items) {
    this.items = items;
    return this;
  }

  public Groups addItemsItem(Group itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.items, groups.items) &&
        super.equals(o);
  }

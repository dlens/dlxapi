...
public class Permissions extends DlCollection {
  @SerializedName("items")
  private List<Permission> items = null;

  public Permissions items(List<Permission> items) {
    this.items = items;
    return this;
  }

  public Permissions addItemsItem(Permission itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.items, permissions.items) &&
        super.equals(o);
  }

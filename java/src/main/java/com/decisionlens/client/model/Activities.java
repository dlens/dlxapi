...
public class Activities extends DlCollection {
  @SerializedName("items")
  private List<Activity> items = null;

  public Activities items(List<Activity> items) {
    this.items = items;
    return this;
  }

  public Activities addItemsItem(Activity itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.items, activities.items) &&
        super.equals(o);
  }

...
package com.decisionlens.client;
...
public class JSON {
    ...
    public static GsonBuilder createGson() {
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
          .registerTypeSelector(DlCollection.class, new TypeSelector() {
            @Override
            public Class getClassForElement(JsonElement readElement) {
                ...
                classByDiscriminatorValue.put("PortfolioPlans".toUpperCase(), PortfolioPlans.class);
                classByDiscriminatorValue.put("Portfolios".toUpperCase(), Portfolios.class);
                classByDiscriminatorValue.put("Projects".toUpperCase(), Projects.class);
                classByDiscriminatorValue.put("Properties".toUpperCase(), Properties.class);
          ...
          .registerTypeSelector(DlResource.class, new TypeSelector() {
            @Override
            public Class getClassForElement(JsonElement readElement) {
                Map classByDiscriminatorValue = new HashMap();
                ...
                classByDiscriminatorValue.put("PortfolioPlan".toUpperCase(), PortfolioPlan.class);
                classByDiscriminatorValue.put("PortfolioPlanInsights".toUpperCase(), PortfolioPlanInsights.class);

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.NotificationsApi();
  });
  ...
  describe('NotificationsApi', function() {
    ...
    describe('reindexNotifications', function() {
      it('should call reindexNotifications successfully', function(done) {
        //uncomment below and update the code to test reindexNotifications
        //instance.reindexNotifications(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.ResourcePoolDeletedEvent();
  });
  ...
  describe('ResourcePoolDeletedEvent', function() {
    it('should create an instance of ResourcePoolDeletedEvent', function() {
      // uncomment below and update the code to test ResourcePoolDeletedEvent
      //var instance = new DecisionLensApi.ResourcePoolDeletedEvent();
      //expect(instance).to.be.a(DecisionLensApi.ResourcePoolDeletedEvent);
    });

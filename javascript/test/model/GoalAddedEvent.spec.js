...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.GoalAddedEvent();
  });
  ...
  describe('GoalAddedEvent', function() {
    it('should create an instance of GoalAddedEvent', function() {
      // uncomment below and update the code to test GoalAddedEvent
      //var instance = new DecisionLensApi.GoalAddedEvent();
      //expect(instance).to.be.a(DecisionLensApi.GoalAddedEvent);
    });

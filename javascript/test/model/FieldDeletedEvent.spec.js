...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.FieldDeletedEvent();
  });
  ...
  describe('FieldDeletedEvent', function() {
    it('should create an instance of FieldDeletedEvent', function() {
      // uncomment below and update the code to test FieldDeletedEvent
      //var instance = new DecisionLensApi.FieldDeletedEvent();
      //expect(instance).to.be.a(DecisionLensApi.FieldDeletedEvent);
    });

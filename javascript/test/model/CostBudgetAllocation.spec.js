...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.CostBudgetAllocation();
  });
  ...
  describe('CostBudgetAllocation', function() {
    it('should create an instance of CostBudgetAllocation', function() {
      // uncomment below and update the code to test CostBudgetAllocation
      //var instance = new DecisionLensApi.CostBudgetAllocation();
      //expect(instance).to.be.a(DecisionLensApi.CostBudgetAllocation);
    });

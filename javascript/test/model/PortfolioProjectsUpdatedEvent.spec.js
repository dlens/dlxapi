...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.PortfolioProjectsUpdatedEvent();
  });
  ...
  describe('PortfolioProjectsUpdatedEvent', function() {
    it('should create an instance of PortfolioProjectsUpdatedEvent', function() {
      // uncomment below and update the code to test PortfolioProjectsUpdatedEvent
      //var instance = new DecisionLensApi.PortfolioProjectsUpdatedEvent();
      //expect(instance).to.be.a(DecisionLensApi.PortfolioProjectsUpdatedEvent);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.CustomNameAddedEvent();
  });
  ...
  describe('CustomNameAddedEvent', function() {
    it('should create an instance of CustomNameAddedEvent', function() {
      // uncomment below and update the code to test CustomNameAddedEvent
      //var instance = new DecisionLensApi.CustomNameAddedEvent();
      //expect(instance).to.be.a(DecisionLensApi.CustomNameAddedEvent);
    });

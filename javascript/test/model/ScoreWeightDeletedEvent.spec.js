...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.ScoreWeightDeletedEvent();
  });
  ...
  describe('ScoreWeightDeletedEvent', function() {
    it('should create an instance of ScoreWeightDeletedEvent', function() {
      // uncomment below and update the code to test ScoreWeightDeletedEvent
      //var instance = new DecisionLensApi.ScoreWeightDeletedEvent();
      //expect(instance).to.be.a(DecisionLensApi.ScoreWeightDeletedEvent);
    });

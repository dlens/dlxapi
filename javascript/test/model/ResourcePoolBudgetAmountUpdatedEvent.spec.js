...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.ResourcePoolBudgetAmountUpdatedEvent();
  });
  ...
  describe('ResourcePoolBudgetAmountUpdatedEvent', function() {
    it('should create an instance of ResourcePoolBudgetAmountUpdatedEvent', function() {
      // uncomment below and update the code to test ResourcePoolBudgetAmountUpdatedEvent
      //var instance = new DecisionLensApi.ResourcePoolBudgetAmountUpdatedEvent();
      //expect(instance).to.be.a(DecisionLensApi.ResourcePoolBudgetAmountUpdatedEvent);
    });

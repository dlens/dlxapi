...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.PortfolioArchivedEvent();
  });
  ...
  describe('PortfolioArchivedEvent', function() {
    it('should create an instance of PortfolioArchivedEvent', function() {
      // uncomment below and update the code to test PortfolioArchivedEvent
      //var instance = new DecisionLensApi.PortfolioArchivedEvent();
      //expect(instance).to.be.a(DecisionLensApi.PortfolioArchivedEvent);
    });

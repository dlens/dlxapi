...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.CommentAddedEvent();
  });
  ...
  describe('CommentAddedEvent', function() {
    it('should create an instance of CommentAddedEvent', function() {
      // uncomment below and update the code to test CommentAddedEvent
      //var instance = new DecisionLensApi.CommentAddedEvent();
      //expect(instance).to.be.a(DecisionLensApi.CommentAddedEvent);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.FieldCategoryOptionsUpdatedEvent();
  });
  ...
  describe('FieldCategoryOptionsUpdatedEvent', function() {
    it('should create an instance of FieldCategoryOptionsUpdatedEvent', function() {
      // uncomment below and update the code to test FieldCategoryOptionsUpdatedEvent
      //var instance = new DecisionLensApi.FieldCategoryOptionsUpdatedEvent();
      //expect(instance).to.be.a(DecisionLensApi.FieldCategoryOptionsUpdatedEvent);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.AttachmentDeletedEvent();
  });
  ...
  describe('AttachmentDeletedEvent', function() {
    it('should create an instance of AttachmentDeletedEvent', function() {
      // uncomment below and update the code to test AttachmentDeletedEvent
      //var instance = new DecisionLensApi.AttachmentDeletedEvent();
      //expect(instance).to.be.a(DecisionLensApi.AttachmentDeletedEvent);
    });

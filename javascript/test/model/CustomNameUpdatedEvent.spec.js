...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.CustomNameUpdatedEvent();
  });
  ...
  describe('CustomNameUpdatedEvent', function() {
    it('should create an instance of CustomNameUpdatedEvent', function() {
      // uncomment below and update the code to test CustomNameUpdatedEvent
      //var instance = new DecisionLensApi.CustomNameUpdatedEvent();
      //expect(instance).to.be.a(DecisionLensApi.CustomNameUpdatedEvent);
    });

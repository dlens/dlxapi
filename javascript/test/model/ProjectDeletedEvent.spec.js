...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.ProjectDeletedEvent();
  });
  ...
  describe('ProjectDeletedEvent', function() {
    it('should create an instance of ProjectDeletedEvent', function() {
      // uncomment below and update the code to test ProjectDeletedEvent
      //var instance = new DecisionLensApi.ProjectDeletedEvent();
      //expect(instance).to.be.a(DecisionLensApi.ProjectDeletedEvent);
    });

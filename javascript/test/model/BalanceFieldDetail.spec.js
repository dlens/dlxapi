...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.BalanceFieldDetail();
  });
  ...
  describe('BalanceFieldDetail', function() {
    it('should create an instance of BalanceFieldDetail', function() {
      // uncomment below and update the code to test BalanceFieldDetail
      //var instance = new DecisionLensApi.BalanceFieldDetail();
      //expect(instance).to.be.a(DecisionLensApi.BalanceFieldDetail);
    });

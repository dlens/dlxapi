...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.AddUsersRequest();
  });
  ...
  describe('AddUsersRequest', function() {
    it('should create an instance of AddUsersRequest', function() {
      // uncomment below and update the code to test AddUsersRequest
      //var instance = new DecisionLensApi.AddUsersRequest();
      //expect(instance).to.be.a(DecisionLensApi.AddUsersRequest);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.ProjectAttachmentAddedEvent();
  });
  ...
  describe('ProjectAttachmentAddedEvent', function() {
    it('should create an instance of ProjectAttachmentAddedEvent', function() {
      // uncomment below and update the code to test ProjectAttachmentAddedEvent
      //var instance = new DecisionLensApi.ProjectAttachmentAddedEvent();
      //expect(instance).to.be.a(DecisionLensApi.ProjectAttachmentAddedEvent);
    });

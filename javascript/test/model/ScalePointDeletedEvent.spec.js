...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.ScalePointDeletedEvent();
  });
  ...
  describe('ScalePointDeletedEvent', function() {
    it('should create an instance of ScalePointDeletedEvent', function() {
      // uncomment below and update the code to test ScalePointDeletedEvent
      //var instance = new DecisionLensApi.ScalePointDeletedEvent();
      //expect(instance).to.be.a(DecisionLensApi.ScalePointDeletedEvent);
    });

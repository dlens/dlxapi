...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.FieldDataTypeUpdatedEvent();
  });
  ...
  describe('FieldDataTypeUpdatedEvent', function() {
    it('should create an instance of FieldDataTypeUpdatedEvent', function() {
      // uncomment below and update the code to test FieldDataTypeUpdatedEvent
      //var instance = new DecisionLensApi.FieldDataTypeUpdatedEvent();
      //expect(instance).to.be.a(DecisionLensApi.FieldDataTypeUpdatedEvent);
    });
    ...
    it('should have the property previousDataType (base name: "previousDataType")', function() {
      // uncomment below and update the code to test the property previousDataType
      //var instance = new DecisionLensApi.FieldDataTypeUpdatedEvent();
      //expect(instance).to.be();
    });

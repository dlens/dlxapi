...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.ProjectTagRemovedEvent();
  });
  ...
  describe('ProjectTagRemovedEvent', function() {
    it('should create an instance of ProjectTagRemovedEvent', function() {
      // uncomment below and update the code to test ProjectTagRemovedEvent
      //var instance = new DecisionLensApi.ProjectTagRemovedEvent();
      //expect(instance).to.be.a(DecisionLensApi.ProjectTagRemovedEvent);
    });

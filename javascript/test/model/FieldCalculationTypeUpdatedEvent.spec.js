...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.FieldCalculationTypeUpdatedEvent();
  });
  ...
  describe('FieldCalculationTypeUpdatedEvent', function() {
    it('should create an instance of FieldCalculationTypeUpdatedEvent', function() {
      // uncomment below and update the code to test FieldCalculationTypeUpdatedEvent
      //var instance = new DecisionLensApi.FieldCalculationTypeUpdatedEvent();
      //expect(instance).to.be.a(DecisionLensApi.FieldCalculationTypeUpdatedEvent);
    });
    ...
    it('should have the property previousCalculationType (base name: "previousCalculationType")', function() {
      // uncomment below and update the code to test the property previousCalculationType
      //var instance = new DecisionLensApi.FieldCalculationTypeUpdatedEvent();
      //expect(instance).to.be();
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.FieldTargetTypeUpdatedEvent();
  });
  ...
  describe('FieldTargetTypeUpdatedEvent', function() {
    it('should create an instance of FieldTargetTypeUpdatedEvent', function() {
      // uncomment below and update the code to test FieldTargetTypeUpdatedEvent
      //var instance = new DecisionLensApi.FieldTargetTypeUpdatedEvent();
      //expect(instance).to.be.a(DecisionLensApi.FieldTargetTypeUpdatedEvent);
    });
    ...
    it('should have the property previousTargetType (base name: "previousTargetType")', function() {
      // uncomment below and update the code to test the property previousTargetType
      //var instance = new DecisionLensApi.FieldTargetTypeUpdatedEvent();
      //expect(instance).to.be();
    });

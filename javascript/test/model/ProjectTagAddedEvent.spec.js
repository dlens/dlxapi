...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.ProjectTagAddedEvent();
  });
  ...
  describe('ProjectTagAddedEvent', function() {
    it('should create an instance of ProjectTagAddedEvent', function() {
      // uncomment below and update the code to test ProjectTagAddedEvent
      //var instance = new DecisionLensApi.ProjectTagAddedEvent();
      //expect(instance).to.be.a(DecisionLensApi.ProjectTagAddedEvent);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.FieldNameUpdatedEvent();
  });
  ...
  describe('FieldNameUpdatedEvent', function() {
    it('should create an instance of FieldNameUpdatedEvent', function() {
      // uncomment below and update the code to test FieldNameUpdatedEvent
      //var instance = new DecisionLensApi.FieldNameUpdatedEvent();
      //expect(instance).to.be.a(DecisionLensApi.FieldNameUpdatedEvent);
    });

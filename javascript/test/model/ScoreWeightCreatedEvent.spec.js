...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.ScoreWeightCreatedEvent();
  });
  ...
  describe('ScoreWeightCreatedEvent', function() {
    it('should create an instance of ScoreWeightCreatedEvent', function() {
      // uncomment below and update the code to test ScoreWeightCreatedEvent
      //var instance = new DecisionLensApi.ScoreWeightCreatedEvent();
      //expect(instance).to.be.a(DecisionLensApi.ScoreWeightCreatedEvent);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.ProjectContributingUserAddedEvent();
  });
  ...
  describe('ProjectContributingUserAddedEvent', function() {
    it('should create an instance of ProjectContributingUserAddedEvent', function() {
      // uncomment below and update the code to test ProjectContributingUserAddedEvent
      //var instance = new DecisionLensApi.ProjectContributingUserAddedEvent();
      //expect(instance).to.be.a(DecisionLensApi.ProjectContributingUserAddedEvent);
    });

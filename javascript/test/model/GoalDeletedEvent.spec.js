...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.GoalDeletedEvent();
  });
  ...
  describe('GoalDeletedEvent', function() {
    it('should create an instance of GoalDeletedEvent', function() {
      // uncomment below and update the code to test GoalDeletedEvent
      //var instance = new DecisionLensApi.GoalDeletedEvent();
      //expect(instance).to.be.a(DecisionLensApi.GoalDeletedEvent);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.PortfolioPlanDeletedEvent();
  });
  ...
  describe('PortfolioPlanDeletedEvent', function() {
    it('should create an instance of PortfolioPlanDeletedEvent', function() {
      // uncomment below and update the code to test PortfolioPlanDeletedEvent
      //var instance = new DecisionLensApi.PortfolioPlanDeletedEvent();
      //expect(instance).to.be.a(DecisionLensApi.PortfolioPlanDeletedEvent);
    });

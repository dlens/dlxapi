...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.FieldTypeUpdatedEvent();
  });
  ...
  describe('FieldTypeUpdatedEvent', function() {
    it('should create an instance of FieldTypeUpdatedEvent', function() {
      // uncomment below and update the code to test FieldTypeUpdatedEvent
      //var instance = new DecisionLensApi.FieldTypeUpdatedEvent();
      //expect(instance).to.be.a(DecisionLensApi.FieldTypeUpdatedEvent);
    });
    ...
    it('should have the property previousFieldType (base name: "previousFieldType")', function() {
      // uncomment below and update the code to test the property previousFieldType
      //var instance = new DecisionLensApi.FieldTypeUpdatedEvent();
      //expect(instance).to.be();
    });

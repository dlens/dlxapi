...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.ScoreWeightFieldWeightLockUpdatedEvent();
  });
  ...
  describe('ScoreWeightFieldWeightLockUpdatedEvent', function() {
    it('should create an instance of ScoreWeightFieldWeightLockUpdatedEvent', function() {
      // uncomment below and update the code to test ScoreWeightFieldWeightLockUpdatedEvent
      //var instance = new DecisionLensApi.ScoreWeightFieldWeightLockUpdatedEvent();
      //expect(instance).to.be.a(DecisionLensApi.ScoreWeightFieldWeightLockUpdatedEvent);
    });
    ...
    it('should have the property previousIsLocked (base name: "previousIsLocked")', function() {
      // uncomment below and update the code to test the property previousIsLocked
      //var instance = new DecisionLensApi.ScoreWeightFieldWeightLockUpdatedEvent();
      //expect(instance).to.be();
    });

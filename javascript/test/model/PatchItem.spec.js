...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.PatchItem();
  });
  ...
  describe('PatchItem', function() {
    it('should create an instance of PatchItem', function() {
      // uncomment below and update the code to test PatchItem
      //var instance = new DecisionLensApi.PatchItem();
      //expect(instance).to.be.a(DecisionLensApi.PatchItem);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.CategoryOption();
  });
  ...
  describe('CategoryOption', function() {
    it('should create an instance of CategoryOption', function() {
      // uncomment below and update the code to test CategoryOption
      //var instance = new DecisionLensApi.CategoryOption();
      //expect(instance).to.be.a(DecisionLensApi.CategoryOption);
    });

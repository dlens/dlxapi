...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.CommentDeletedEvent();
  });
  ...
  describe('CommentDeletedEvent', function() {
    it('should create an instance of CommentDeletedEvent', function() {
      // uncomment below and update the code to test CommentDeletedEvent
      //var instance = new DecisionLensApi.CommentDeletedEvent();
      //expect(instance).to.be.a(DecisionLensApi.CommentDeletedEvent);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.IdeaFormFieldRequest();
  });
  ...
  describe('IdeaFormFieldRequest', function() {
    it('should create an instance of IdeaFormFieldRequest', function() {
      // uncomment below and update the code to test IdeaFormFieldRequest
      //var instance = new DecisionLensApi.IdeaFormFieldRequest();
      //expect(instance).to.be.a(DecisionLensApi.IdeaFormFieldRequest);
    });
    ...
    it('should have the property isIncluded (base name: "isIncluded")', function() {

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.RiskFieldDetail();
  });
  ...
  describe('RiskFieldDetail', function() {
    it('should create an instance of RiskFieldDetail', function() {
      // uncomment below and update the code to test RiskFieldDetail
      //var instance = new DecisionLensApi.RiskFieldDetail();
      //expect(instance).to.be.a(DecisionLensApi.RiskFieldDetail);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.ProjectCreatedEvent();
  });
  ...
  describe('ProjectCreatedEvent', function() {
    it('should create an instance of ProjectCreatedEvent', function() {
      // uncomment below and update the code to test ProjectCreatedEvent
      //var instance = new DecisionLensApi.ProjectCreatedEvent();
      //expect(instance).to.be.a(DecisionLensApi.ProjectCreatedEvent);
    });

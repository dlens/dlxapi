...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.AttachmentCreatedEvent();
  });
  ...
  describe('AttachmentCreatedEvent', function() {
    it('should create an instance of AttachmentCreatedEvent', function() {
      // uncomment below and update the code to test AttachmentCreatedEvent
      //var instance = new DecisionLensApi.AttachmentCreatedEvent();
      //expect(instance).to.be.a(DecisionLensApi.AttachmentCreatedEvent);
    });

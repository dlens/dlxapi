...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.ScoreWeightFieldWeightDeletedEvent();
  });
  ...
  describe('ScoreWeightFieldWeightDeletedEvent', function() {
    it('should create an instance of ScoreWeightFieldWeightDeletedEvent', function() {
      // uncomment below and update the code to test ScoreWeightFieldWeightDeletedEvent
      //var instance = new DecisionLensApi.ScoreWeightFieldWeightDeletedEvent();
      //expect(instance).to.be.a(DecisionLensApi.ScoreWeightFieldWeightDeletedEvent);
    });

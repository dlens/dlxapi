...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.FieldTypePositionUpdatedEvent();
  });
  ...
  describe('FieldTypePositionUpdatedEvent', function() {
    it('should create an instance of FieldTypePositionUpdatedEvent', function() {
      // uncomment below and update the code to test FieldTypePositionUpdatedEvent
      //var instance = new DecisionLensApi.FieldTypePositionUpdatedEvent();
      //expect(instance).to.be.a(DecisionLensApi.FieldTypePositionUpdatedEvent);
    });

    it('should have the property previousTypePosition (base name: "previousTypePosition")', function() {
      // uncomment below and update the code to test the property previousTypePosition
      //var instance = new DecisionLensApi.FieldTypePositionUpdatedEvent();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.ProjectPortfolioPlanFieldValueDeletedEvent();
  });
  ...
  describe('ProjectPortfolioPlanFieldValueDeletedEvent', function() {
    it('should create an instance of ProjectPortfolioPlanFieldValueDeletedEvent', function() {
      // uncomment below and update the code to test ProjectPortfolioPlanFieldValueDeletedEvent
      //var instance = new DecisionLensApi.ProjectPortfolioPlanFieldValueDeletedEvent();
      //expect(instance).to.be.a(DecisionLensApi.ProjectPortfolioPlanFieldValueDeletedEvent);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.FieldTagRemovedEvent();
  });
  ...
  describe('FieldTagRemovedEvent', function() {
    it('should create an instance of FieldTagRemovedEvent', function() {
      // uncomment below and update the code to test FieldTagRemovedEvent
      //var instance = new DecisionLensApi.FieldTagRemovedEvent();
      //expect(instance).to.be.a(DecisionLensApi.FieldTagRemovedEvent);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.SourceDeletedEvent();
  });
  ...
  describe('SourceDeletedEvent', function() {
    it('should create an instance of SourceDeletedEvent', function() {
      // uncomment below and update the code to test SourceDeletedEvent
      //var instance = new DecisionLensApi.SourceDeletedEvent();
      //expect(instance).to.be.a(DecisionLensApi.SourceDeletedEvent);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.Classification();
  });
  ...
  describe('Classification', function() {
    it('should create an instance of Classification', function() {
      ...
      //var instance = new DecisionLensApi.Classification();
      //expect(instance).to.be.a(DecisionLensApi.Classification);
    });
    ...
    it('should have the property planFeature (base name: "planFeature")', function() {
      // uncomment below and update the code to test the property planFeature
      //var instance = new DecisionLensApi.Classification();
      //expect(instance).to.be();
    });

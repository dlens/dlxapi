...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.ResourcePoolFieldValuePatchItem();
  });
  ...
  describe('ResourcePoolFieldValuePatchItem', function() {
    it('should create an instance of ResourcePoolFieldValuePatchItem', function() {
      // uncomment below and update the code to test ResourcePoolFieldValuePatchItem
      //var instance = new DecisionLensApi.ResourcePoolFieldValuePatchItem();
      //expect(instance).to.be.a(DecisionLensApi.ResourcePoolFieldValuePatchItem);
    });

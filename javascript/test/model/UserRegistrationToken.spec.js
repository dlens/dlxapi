...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.UserRegistrationToken();
  });
  ...
  describe('UserRegistrationToken', function() {
    it('should create an instance of UserRegistrationToken', function() {
      // uncomment below and update the code to test UserRegistrationToken
      //var instance = new DecisionLensApi.UserRegistrationToken();
      //expect(instance).to.be.a(DecisionLensApi.UserRegistrationToken);
    });

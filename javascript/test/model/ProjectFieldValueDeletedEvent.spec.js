...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.ProjectFieldValueDeletedEvent();
  });
  ...
  describe('ProjectFieldValueDeletedEvent', function() {
    it('should create an instance of ProjectFieldValueDeletedEvent', function() {
      // uncomment below and update the code to test ProjectFieldValueDeletedEvent
      //var instance = new DecisionLensApi.ProjectFieldValueDeletedEvent();
      //expect(instance).to.be.a(DecisionLensApi.ProjectFieldValueDeletedEvent);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.ProjectFieldValue();
  });
  ...
  describe('ProjectFieldValue', function() {
    it('should create an instance of ProjectFieldValue', function() {
      // uncomment below and update the code to test ProjectFieldValue
      //var instance = new DecisionLensApi.ProjectFieldValue();
      //expect(instance).to.be.a(DecisionLensApi.ProjectFieldValue);
    });

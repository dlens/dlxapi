...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DecisionLensApi.ProjectFieldValuesDeletedEvent();
  });
  ...
  describe('ProjectFieldValuesDeletedEvent', function() {
    it('should create an instance of ProjectFieldValuesDeletedEvent', function() {
      // uncomment below and update the code to test ProjectFieldValuesDeletedEvent
      //var instance = new DecisionLensApi.ProjectFieldValuesDeletedEvent();
      //expect(instance).to.be.a(DecisionLensApi.ProjectFieldValuesDeletedEvent);
    });

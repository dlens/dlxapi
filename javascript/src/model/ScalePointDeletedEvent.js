...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.ScalePointDeletedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.Field, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The ScalePointDeletedEvent model module.
   * @module model/ScalePointDeletedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>ScalePointDeletedEvent</code>.
   * @alias module:model/ScalePointDeletedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>ScalePointDeletedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ScalePointDeletedEvent} obj Optional instance to populate.
   * @return {module:model/ScalePointDeletedEvent} The populated <code>ScalePointDeletedEvent</code> instance.
   */

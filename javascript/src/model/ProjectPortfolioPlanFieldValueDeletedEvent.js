...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.ProjectPortfolioPlanFieldValueDeletedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.Field, root.DecisionLensApi.PortfolioPlan, root.DecisionLensApi.TimePeriod);
  }
  ...
  /**
   * The ProjectPortfolioPlanFieldValueDeletedEvent model module.
   * @module model/ProjectPortfolioPlanFieldValueDeletedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>ProjectPortfolioPlanFieldValueDeletedEvent</code>.
   * @alias module:model/ProjectPortfolioPlanFieldValueDeletedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>ProjectPortfolioPlanFieldValueDeletedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProjectPortfolioPlanFieldValueDeletedEvent} obj Optional instance to populate.
   * @return {module:model/ProjectPortfolioPlanFieldValueDeletedEvent} The populated <code>ProjectPortfolioPlanFieldValueDeletedEvent</code> instance.
   */

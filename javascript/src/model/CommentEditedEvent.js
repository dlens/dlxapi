...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.CommentEditedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The CommentEditedEvent model module.
   * @module model/CommentEditedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>CommentEditedEvent</code>.
   * @alias module:model/CommentEditedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>CommentEditedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CommentEditedEvent} obj Optional instance to populate.
   * @return {module:model/CommentEditedEvent} The populated <code>CommentEditedEvent</code> instance.
   */

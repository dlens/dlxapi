...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Classification', 'model/DlCollection'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Classification'), require('./DlCollection'));
  } else {
    // Browser globals (root is window)
    if (!root.DecisionLensApi) {
      root.DecisionLensApi = {};
    }
    root.DecisionLensApi.Classifications = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.Classification, root.DecisionLensApi.DlCollection);
  }
}(this, function(ApiClient, Classification, DlCollection) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('items')) {
        obj['items'] = ApiClient.convertToType(data['items'], [Classification]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/Classification>} items
   */

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Comment', 'model/DlCollection'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Comment'), require('./DlCollection'));
  } else {
    // Browser globals (root is window)
    if (!root.DecisionLensApi) {
      root.DecisionLensApi = {};
    }
    root.DecisionLensApi.Comments = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.Comment, root.DecisionLensApi.DlCollection);
  }
}(this, function(ApiClient, Comment, DlCollection) {
  'use strict';

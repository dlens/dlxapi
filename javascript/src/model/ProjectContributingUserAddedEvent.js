...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.ProjectContributingUserAddedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan, root.DecisionLensApi.User);
  }
  ...
  /**
   * The ProjectContributingUserAddedEvent model module.
   * @module model/ProjectContributingUserAddedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>ProjectContributingUserAddedEvent</code>.
   * @alias module:model/ProjectContributingUserAddedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>ProjectContributingUserAddedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProjectContributingUserAddedEvent} obj Optional instance to populate.
   * @return {module:model/ProjectContributingUserAddedEvent} The populated <code>ProjectContributingUserAddedEvent</code> instance.
   */

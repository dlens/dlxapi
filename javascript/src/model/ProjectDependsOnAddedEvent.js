...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.ProjectDependsOnAddedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan, root.DecisionLensApi.Project);
  }
  ...
  /**
   * The ProjectDependsOnAddedEvent model module.
   * @module model/ProjectDependsOnAddedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>ProjectDependsOnAddedEvent</code>.
   * @alias module:model/ProjectDependsOnAddedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>ProjectDependsOnAddedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProjectDependsOnAddedEvent} obj Optional instance to populate.
   * @return {module:model/ProjectDependsOnAddedEvent} The populated <code>ProjectDependsOnAddedEvent</code> instance.
   */

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.ScoreWeightFieldWeightCreatedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.Field, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The ScoreWeightFieldWeightCreatedEvent model module.
   * @module model/ScoreWeightFieldWeightCreatedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>ScoreWeightFieldWeightCreatedEvent</code>.
   * @alias module:model/ScoreWeightFieldWeightCreatedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>ScoreWeightFieldWeightCreatedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ScoreWeightFieldWeightCreatedEvent} obj Optional instance to populate.
   * @return {module:model/ScoreWeightFieldWeightCreatedEvent} The populated <code>ScoreWeightFieldWeightCreatedEvent</code> instance.
   */

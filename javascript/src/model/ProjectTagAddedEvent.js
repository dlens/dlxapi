...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.ProjectTagAddedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The ProjectTagAddedEvent model module.
   * @module model/ProjectTagAddedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>ProjectTagAddedEvent</code>.
   * @alias module:model/ProjectTagAddedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>ProjectTagAddedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProjectTagAddedEvent} obj Optional instance to populate.
   * @return {module:model/ProjectTagAddedEvent} The populated <code>ProjectTagAddedEvent</code> instance.
   */

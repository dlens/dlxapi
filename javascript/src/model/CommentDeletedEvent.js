...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.CommentDeletedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The CommentDeletedEvent model module.
   * @module model/CommentDeletedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>CommentDeletedEvent</code>.
   * @alias module:model/CommentDeletedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>CommentDeletedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CommentDeletedEvent} obj Optional instance to populate.
   * @return {module:model/CommentDeletedEvent} The populated <code>CommentDeletedEvent</code> instance.
   */

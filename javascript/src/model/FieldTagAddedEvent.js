...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.FieldTagAddedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The FieldTagAddedEvent model module.
   * @module model/FieldTagAddedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>FieldTagAddedEvent</code>.
   * @alias module:model/FieldTagAddedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>FieldTagAddedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FieldTagAddedEvent} obj Optional instance to populate.
   * @return {module:model/FieldTagAddedEvent} The populated <code>FieldTagAddedEvent</code> instance.
   */

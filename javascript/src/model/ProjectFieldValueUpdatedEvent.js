...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.ProjectFieldValueUpdatedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.Field, root.DecisionLensApi.PortfolioPlan, root.DecisionLensApi.TimePeriod);
  }
  ...
  /**
   * The ProjectFieldValueUpdatedEvent model module.
   * @module model/ProjectFieldValueUpdatedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>ProjectFieldValueUpdatedEvent</code>.
   * @alias module:model/ProjectFieldValueUpdatedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>ProjectFieldValueUpdatedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProjectFieldValueUpdatedEvent} obj Optional instance to populate.
   * @return {module:model/ProjectFieldValueUpdatedEvent} The populated <code>ProjectFieldValueUpdatedEvent</code> instance.
   */

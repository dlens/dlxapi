...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.PortfolioPlanNameUpdatedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The PortfolioPlanNameUpdatedEvent model module.
   * @module model/PortfolioPlanNameUpdatedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>PortfolioPlanNameUpdatedEvent</code>.
   * @alias module:model/PortfolioPlanNameUpdatedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>PortfolioPlanNameUpdatedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PortfolioPlanNameUpdatedEvent} obj Optional instance to populate.
   * @return {module:model/PortfolioPlanNameUpdatedEvent} The populated <code>PortfolioPlanNameUpdatedEvent</code> instance.
   */

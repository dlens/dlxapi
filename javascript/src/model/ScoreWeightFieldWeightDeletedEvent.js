...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.ScoreWeightFieldWeightDeletedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.Field, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The ScoreWeightFieldWeightDeletedEvent model module.
   * @module model/ScoreWeightFieldWeightDeletedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>ScoreWeightFieldWeightDeletedEvent</code>.
   * @alias module:model/ScoreWeightFieldWeightDeletedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>ScoreWeightFieldWeightDeletedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ScoreWeightFieldWeightDeletedEvent} obj Optional instance to populate.
   * @return {module:model/ScoreWeightFieldWeightDeletedEvent} The populated <code>ScoreWeightFieldWeightDeletedEvent</code> instance.
   */

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.PortfolioProjectsCreatedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The PortfolioProjectsCreatedEvent model module.
   * @module model/PortfolioProjectsCreatedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>PortfolioProjectsCreatedEvent</code>.
   * @alias module:model/PortfolioProjectsCreatedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>PortfolioProjectsCreatedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PortfolioProjectsCreatedEvent} obj Optional instance to populate.
   * @return {module:model/PortfolioProjectsCreatedEvent} The populated <code>PortfolioProjectsCreatedEvent</code> instance.
   */

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.ResourcePoolFieldValueUpdatedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.Field, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The ResourcePoolFieldValueUpdatedEvent model module.
   * @module model/ResourcePoolFieldValueUpdatedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>ResourcePoolFieldValueUpdatedEvent</code>.
   * @alias module:model/ResourcePoolFieldValueUpdatedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>ResourcePoolFieldValueUpdatedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResourcePoolFieldValueUpdatedEvent} obj Optional instance to populate.
   * @return {module:model/ResourcePoolFieldValueUpdatedEvent} The populated <code>ResourcePoolFieldValueUpdatedEvent</code> instance.
   */

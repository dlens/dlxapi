...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.PortfolioNameUpdatedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The PortfolioNameUpdatedEvent model module.
   * @module model/PortfolioNameUpdatedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>PortfolioNameUpdatedEvent</code>.
   * @alias module:model/PortfolioNameUpdatedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>PortfolioNameUpdatedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PortfolioNameUpdatedEvent} obj Optional instance to populate.
   * @return {module:model/PortfolioNameUpdatedEvent} The populated <code>PortfolioNameUpdatedEvent</code> instance.
   */

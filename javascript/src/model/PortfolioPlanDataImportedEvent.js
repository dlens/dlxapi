...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.PortfolioPlanDataImportedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The PortfolioPlanDataImportedEvent model module.
   * @module model/PortfolioPlanDataImportedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>PortfolioPlanDataImportedEvent</code>.
   * @alias module:model/PortfolioPlanDataImportedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>PortfolioPlanDataImportedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PortfolioPlanDataImportedEvent} obj Optional instance to populate.
   * @return {module:model/PortfolioPlanDataImportedEvent} The populated <code>PortfolioPlanDataImportedEvent</code> instance.
   */

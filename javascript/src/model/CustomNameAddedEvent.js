...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.CustomNameAddedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The CustomNameAddedEvent model module.
   * @module model/CustomNameAddedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>CustomNameAddedEvent</code>.
   * @alias module:model/CustomNameAddedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>CustomNameAddedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CustomNameAddedEvent} obj Optional instance to populate.
   * @return {module:model/CustomNameAddedEvent} The populated <code>CustomNameAddedEvent</code> instance.
   */

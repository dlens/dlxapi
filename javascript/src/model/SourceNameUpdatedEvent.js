...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.SourceNameUpdatedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan, root.DecisionLensApi.SourceType);
  }
  ...
  /**
   * The SourceNameUpdatedEvent model module.
   * @module model/SourceNameUpdatedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>SourceNameUpdatedEvent</code>.
   * @alias module:model/SourceNameUpdatedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>SourceNameUpdatedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SourceNameUpdatedEvent} obj Optional instance to populate.
   * @return {module:model/SourceNameUpdatedEvent} The populated <code>SourceNameUpdatedEvent</code> instance.
   */

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.PortfolioPlanCreatedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The PortfolioPlanCreatedEvent model module.
   * @module model/PortfolioPlanCreatedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>PortfolioPlanCreatedEvent</code>.
   * @alias module:model/PortfolioPlanCreatedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>PortfolioPlanCreatedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PortfolioPlanCreatedEvent} obj Optional instance to populate.
   * @return {module:model/PortfolioPlanCreatedEvent} The populated <code>PortfolioPlanCreatedEvent</code> instance.
   */

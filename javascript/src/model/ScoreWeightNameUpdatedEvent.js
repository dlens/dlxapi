...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.ScoreWeightNameUpdatedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The ScoreWeightNameUpdatedEvent model module.
   * @module model/ScoreWeightNameUpdatedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>ScoreWeightNameUpdatedEvent</code>.
   * @alias module:model/ScoreWeightNameUpdatedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>ScoreWeightNameUpdatedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ScoreWeightNameUpdatedEvent} obj Optional instance to populate.
   * @return {module:model/ScoreWeightNameUpdatedEvent} The populated <code>ScoreWeightNameUpdatedEvent</code> instance.
   */

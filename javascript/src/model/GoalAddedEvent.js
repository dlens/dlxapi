...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.GoalAddedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The GoalAddedEvent model module.
   * @module model/GoalAddedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>GoalAddedEvent</code>.
   * @alias module:model/GoalAddedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>GoalAddedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GoalAddedEvent} obj Optional instance to populate.
   * @return {module:model/GoalAddedEvent} The populated <code>GoalAddedEvent</code> instance.
   */

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.CustomNameDeletedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The CustomNameDeletedEvent model module.
   * @module model/CustomNameDeletedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>CustomNameDeletedEvent</code>.
   * @alias module:model/CustomNameDeletedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>CustomNameDeletedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CustomNameDeletedEvent} obj Optional instance to populate.
   * @return {module:model/CustomNameDeletedEvent} The populated <code>CustomNameDeletedEvent</code> instance.
   */

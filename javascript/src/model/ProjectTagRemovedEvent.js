...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.ProjectTagRemovedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The ProjectTagRemovedEvent model module.
   * @module model/ProjectTagRemovedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>ProjectTagRemovedEvent</code>.
   * @alias module:model/ProjectTagRemovedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>ProjectTagRemovedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProjectTagRemovedEvent} obj Optional instance to populate.
   * @return {module:model/ProjectTagRemovedEvent} The populated <code>ProjectTagRemovedEvent</code> instance.
   */

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.PortfolioArchivedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The PortfolioArchivedEvent model module.
   * @module model/PortfolioArchivedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>PortfolioArchivedEvent</code>.
   * @alias module:model/PortfolioArchivedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>PortfolioArchivedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PortfolioArchivedEvent} obj Optional instance to populate.
   * @return {module:model/PortfolioArchivedEvent} The populated <code>PortfolioArchivedEvent</code> instance.
   */

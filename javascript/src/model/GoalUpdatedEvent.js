...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.GoalUpdatedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The GoalUpdatedEvent model module.
   * @module model/GoalUpdatedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>GoalUpdatedEvent</code>.
   * @alias module:model/GoalUpdatedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>GoalUpdatedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GoalUpdatedEvent} obj Optional instance to populate.
   * @return {module:model/GoalUpdatedEvent} The populated <code>GoalUpdatedEvent</code> instance.
   */

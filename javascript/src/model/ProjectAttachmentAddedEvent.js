...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.ProjectAttachmentAddedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The ProjectAttachmentAddedEvent model module.
   * @module model/ProjectAttachmentAddedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>ProjectAttachmentAddedEvent</code>.
   * @alias module:model/ProjectAttachmentAddedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>ProjectAttachmentAddedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProjectAttachmentAddedEvent} obj Optional instance to populate.
   * @return {module:model/ProjectAttachmentAddedEvent} The populated <code>ProjectAttachmentAddedEvent</code> instance.
   */

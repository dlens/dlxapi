...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.ResourcePoolNameUpdatedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The ResourcePoolNameUpdatedEvent model module.
   * @module model/ResourcePoolNameUpdatedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>ResourcePoolNameUpdatedEvent</code>.
   * @alias module:model/ResourcePoolNameUpdatedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>ResourcePoolNameUpdatedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResourcePoolNameUpdatedEvent} obj Optional instance to populate.
   * @return {module:model/ResourcePoolNameUpdatedEvent} The populated <code>ResourcePoolNameUpdatedEvent</code> instance.
   */

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DecisionLensApi.CustomNameUpdatedEvent = factory(root.DecisionLensApi.ApiClient, root.DecisionLensApi.PortfolioPlan);
  }
  ...
  /**
   * The CustomNameUpdatedEvent model module.
   * @module model/CustomNameUpdatedEvent
   * @version 1.0
   */

  /**
   * Constructs a new <code>CustomNameUpdatedEvent</code>.
   * @alias module:model/CustomNameUpdatedEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>CustomNameUpdatedEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CustomNameUpdatedEvent} obj Optional instance to populate.
   * @return {module:model/CustomNameUpdatedEvent} The populated <code>CustomNameUpdatedEvent</code> instance.
   */

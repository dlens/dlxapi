...
class ExpandComponent(object):
    ...
    @property
    def match_keys(self):
        """Gets the match_keys of this ExpandComponent.  # noqa: E501

        filter the collection by only including the matched keys. example - [\"123\",\"456\",\"789\"]  # noqa: E501

        :return: The match_keys of this ExpandComponent.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def match_keys(self, match_keys):
        """Sets the match_keys of this ExpandComponent.

        filter the collection by only including the matched keys. example - [\"123\",\"456\",\"789\"]  # noqa: E501

        :param match_keys: The match_keys of this ExpandComponent.  # noqa: E501
        :type: list[str]
        """

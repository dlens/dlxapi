...
class CommentsApi(object):
    ...
    def get_comments_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['portfolio_id', 'project_id', 'offset', 'limit', 'order_by', 'match', 'only_mentioned']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'only_mentioned' in params:
            query_params.append(('onlyMentioned', params['only_mentioned']))  # noqa: E501
    ...
    def get_comments_summary(self, **kwargs):  # noqa: E501
        """Retrieves comments summary based on params  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_comments_summary(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_comments_summary_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_comments_summary_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_comments_summary_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieves comments summary based on params  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_comments_summary_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['portfolio_id', 'project_id', 'match', 'only_mentioned']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_comments_summary" % key
                )
            params[key] = val
        del params['kwargs']

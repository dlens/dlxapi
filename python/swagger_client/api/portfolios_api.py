...
class PortfoliosApi(object):
    ...
    def get_spreadsheet_report_for_portfolio(self, portfolio_id, spreadsheet_id, sheet_name, **kwargs):  # noqa: E501
        ...
        :param str spreadsheet_id: Spreadsheet id (required)
        :param str sheet_name: Spreadsheet name (required)
        :param object import_type: Import type
        :param str expand: JSON string containing an array expand specifications for fields.  An expand specification must have a path and includes optional properties match, unique, allPossible, limit, offset, orderBy.
        :return: SpreadsheetReport
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def get_spreadsheet_report_for_portfolio_with_http_info(self, portfolio_id, spreadsheet_id, sheet_name, **kwargs):  # noqa: E501
        ...
        all_params = ['portfolio_id', 'spreadsheet_id', 'sheet_name', 'import_type', 'expand']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def save_spreadsheet_for_portfolio_with_http_info(self, portfolio_id, spreadsheet_id, sheet_name, **kwargs):  # noqa: E501
        ...
        all_params = ['portfolio_id', 'spreadsheet_id', 'sheet_name', 'import_type']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def save_spreadsheet_source_for_portfolio(self, id, file, **kwargs):  # noqa: E501
        ...
        :param object import_type: Import type. Defaults to PROJECT.
        :return: Source
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def save_spreadsheet_source_for_portfolio_with_http_info(self, id, file, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'file', 'sheet_name', 'import_type']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def set_custom_names_with_http_info(self, portfolio_id, custom_names, **kwargs):  # noqa: E501
        ...
        if ('custom_names' not in params or
                params['custom_names'] is None):
    ...
    def update_spreadsheet_report_for_portfolio(self, portfolio_id, spreadsheet_id, sheet_name, fields, **kwargs):  # noqa: E501
        """Updates the spreadsheet report for a portfolio  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_spreadsheet_report_for_portfolio(portfolio_id, spreadsheet_id, sheet_name, fields, async_req=True)
        >>> result = thread.get()
        ...
        :param str spreadsheet_id: Spreadsheet id (required)
        :param str sheet_name: Spreadsheet name (required)
        :param list[SpreadsheetField] fields: Spreadsheet fields (required)
        :param str expand: JSON string containing an array expand specifications for fields.  An expand specification must have a path and includes optional properties match, unique, allPossible, limit, offset, orderBy.
        :return: SpreadsheetReport
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_spreadsheet_report_for_portfolio_with_http_info(portfolio_id, spreadsheet_id, sheet_name, fields, **kwargs)  # noqa: E501
        else:
            (data) = self.update_spreadsheet_report_for_portfolio_with_http_info(portfolio_id, spreadsheet_id, sheet_name, fields, **kwargs)  # noqa: E501
            return data

    def update_spreadsheet_report_for_portfolio_with_http_info(self, portfolio_id, spreadsheet_id, sheet_name, fields, **kwargs):  # noqa: E501
        """Updates the spreadsheet report for a portfolio  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_spreadsheet_report_for_portfolio_with_http_info(portfolio_id, spreadsheet_id, sheet_name, fields, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['portfolio_id', 'spreadsheet_id', 'sheet_name', 'fields', 'expand']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('fields' not in params or
            ...
            raise ValueError("Missing the required parameter `fields` when calling `update_spreadsheet_report_for_portfolio`")  # noqa: E501

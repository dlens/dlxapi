...
class GroupsApi(object):
    ...
    def export_group(self, id, **kwargs):  # noqa: E501
        ...
        :param object export_type: export type (GROUP)
        :param object export_format: export format type (XLSX)
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def provision_group(self, provision_group_request, **kwargs):  # noqa: E501
        """Provision a group (tenant).  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.provision_group(provision_group_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ProvisionGroupRequest provision_group_request: Provision a Group (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.provision_group_with_http_info(provision_group_request, **kwargs)  # noqa: E501
        else:
            (data) = self.provision_group_with_http_info(provision_group_request, **kwargs)  # noqa: E501
            return data

    def provision_group_with_http_info(self, provision_group_request, **kwargs):  # noqa: E501
        """Provision a group (tenant).  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.provision_group_with_http_info(provision_group_request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['provision_group_request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'provision_group_request' is set
        if ('provision_group_request' not in params or
                params['provision_group_request'] is None):
            raise ValueError("Missing the required parameter `provision_group_request` when calling `provision_group`")  # noqa: E501
        ...
        body_params = None
        if 'provision_group_request' in params:
            body_params = params['provision_group_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501

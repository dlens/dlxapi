...
class ScoreWeightsApi(object):
    ...
    def update_score_weights_for_portfolio(self, body, **kwargs):  # noqa: E501
        """Updates Score Weights for portfolio  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_score_weights_for_portfolio(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_score_weights_for_portfolio_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_score_weights_for_portfolio_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def update_score_weights_for_portfolio_with_http_info(self, body, **kwargs):  # noqa: E501
        """Updates Score Weights for portfolio  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_score_weights_for_portfolio_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_score_weights_for_portfolio`")  # noqa: E501

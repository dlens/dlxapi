...
class UsersApi(object):
    ...
    def create_user(self, body, **kwargs):  # noqa: E501
        ...
        :param AddUserRequest body: User to create (required)
        :return: User
    ...
    def get_user_activities(self, id, **kwargs):  # noqa: E501
        ...
        :param str match: Semi-colon delimited list of expressions to include in the response only the items in a collections that satisfy the expression(s). All other items should be excluded.
        :return: Activities
                 If the method is called asynchronously,
                 returns the request thread.
        """

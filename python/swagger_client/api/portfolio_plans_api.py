...
class PortfolioPlansApi(object):
    ...
    def add_and_delete_field_values_for_fields(self, portfolio_plan_id, project_id, body, **kwargs):  # noqa: E501
        """add field values for the fields, and remove all field values for fields, for the supplied project  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_and_delete_field_values_for_fields(portfolio_plan_id, project_id, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param object portfolio_plan_id: Portfolio plan id (required)
        :param object project_id: Project id (required)
        ...
        if kwargs.get('async_req'):
            return self.add_and_delete_field_values_for_fields_with_http_info(portfolio_plan_id, project_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.add_and_delete_field_values_for_fields_with_http_info(portfolio_plan_id, project_id, body, **kwargs)  # noqa: E501
            return data

    def add_and_delete_field_values_for_fields_with_http_info(self, portfolio_plan_id, project_id, body, **kwargs):  # noqa: E501
        """add field values for the fields, and remove all field values for fields, for the supplied project  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_and_delete_field_values_for_fields_with_http_info(portfolio_plan_id, project_id, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['portfolio_plan_id', 'project_id', 'body', 'expand']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method add_and_delete_field_values_for_fields" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('portfolio_plan_id' not in params or
            ...
            raise ValueError("Missing the required parameter `portfolio_plan_id` when calling `add_and_delete_field_values_for_fields`")  # noqa: E501
        # verify the required parameter 'project_id' is set
        if ('project_id' not in params or
                params['project_id'] is None):
            raise ValueError("Missing the required parameter `project_id` when calling `add_and_delete_field_values_for_fields`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_and_delete_field_values_for_fields`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/portfolioPlans/{portfolioPlanId}/project/{projectId}/addRemoveCosts', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def export_portfolio_plan(self, id, export_type, export_format, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str id: portfolio plan id (required)
        :param object export_type: export type (PROJECT, SCHEDULE, SPEND_PLAN) (required)
        :param object export_format: export format type (XLSX) (required)
        :param ExportConfig export_config: export configuration object
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def export_portfolio_plan_with_http_info(self, id, export_type, export_format, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'export_type', 'export_format', 'export_config']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        body_params = None
        if 'export_config' in params:
            body_params = params['export_config']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
    ...
    def update_portfolio_plan_budget_field_values(self, id, body, **kwargs):  # noqa: E501
        """Update field values in a portfolio plan  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_portfolio_plan_budget_field_values(id, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param object id: Portfolio plan id (required)
        :param list[ResourcePoolFieldValuePatchItem] body: JSON Patch Operations to update multiple field values. (required)
        :param str expand: JSON string containing an array expand specifications for fields.  An expand specification must have a path and includes optional properties match, unique, allPossible, limit, offset, orderBy.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_portfolio_plan_budget_field_values_with_http_info(id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_portfolio_plan_budget_field_values_with_http_info(id, body, **kwargs)  # noqa: E501
            return data

    def update_portfolio_plan_budget_field_values_with_http_info(self, id, body, **kwargs):  # noqa: E501
        """Update field values in a portfolio plan  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_portfolio_plan_budget_field_values_with_http_info(id, body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_portfolio_plan_budget_field_values" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_portfolio_plan_budget_field_values`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_portfolio_plan_budget_field_values`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[ResourcePoolFieldValue]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_portfolio_plan_field_values_with_http_info(self, id, body, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'body', 'apply_rank', 'preserve_project_access', 'expand']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')

...
class PlansApi(object):
    ...
    def get_insights_for_portfolio_plan(self, id, start_date, end_date, include_grades, **kwargs):  # noqa: E501
        """Retrieves insights for portfolio plan.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_insights_for_portfolio_plan(id, start_date, end_date, include_grades, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: Portfolio Plan id (required)
        :param int start_date: Start time period for which the insights are computed for. (required)
        :param int end_date: End time period for which the insights are computed for. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_insights_for_portfolio_plan_with_http_info(id, start_date, end_date, include_grades, **kwargs)  # noqa: E501
        else:
            (data) = self.get_insights_for_portfolio_plan_with_http_info(id, start_date, end_date, include_grades, **kwargs)  # noqa: E501
            return data

    def get_insights_for_portfolio_plan_with_http_info(self, id, start_date, end_date, include_grades, **kwargs):  # noqa: E501
        """Retrieves insights for portfolio plan.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_insights_for_portfolio_plan_with_http_info(id, start_date, end_date, include_grades, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'start_date', 'end_date', 'include_grades']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')

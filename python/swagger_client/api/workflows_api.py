...
class WorkflowsApi(object):
    ...
    def create_workflow(self, body, **kwargs):  # noqa: E501
        ...
        :param Workflow body: Workflow to create (required)
        :return: Workflow
    ...
    def delete_workflow(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str id: ID of the workflow to delete (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_all_workflows(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param list[WorkflowState] state: Filter workflows by state(s)

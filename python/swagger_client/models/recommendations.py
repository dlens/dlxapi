...
import six
from swagger_client.models.dl_collection import DlCollection  # noqa: F401,E501

class Recommendations(DlCollection):
    ...
    swagger_types = {
        ...
        'initial_portfolio_plan_insights': 'PortfolioPlanInsights',
        'schedule_result_info': 'str',
        'overconstrained_message': 'str'
    }
    if hasattr(DlCollection, "swagger_types"):
        swagger_types.update(DlCollection.swagger_types)

    attribute_map = {
        'portfolio_plan_id': 'portfolioPlanId',
        'items': 'items',
        'initial_portfolio_plan_insights': 'initialPortfolioPlanInsights',
    ...
    def __init__(self, portfolio_plan_id=None, items=None, initial_portfolio_plan_insights=None, schedule_result_info=None, overconstrained_message=None, _check_required=True, *args, **kwargs):  # noqa: E501
        ...
        self._items = None
        self._initial_portfolio_plan_insights = None
        ...
        if items is not None:
            self.items = items
        if initial_portfolio_plan_insights is not None:
            self.initial_portfolio_plan_insights = initial_portfolio_plan_insights
    ...
    @property
    def initial_portfolio_plan_insights(self):
        """Gets the initial_portfolio_plan_insights of this Recommendations.  # noqa: E501


        :return: The initial_portfolio_plan_insights of this Recommendations.  # noqa: E501
        :rtype: PortfolioPlanInsights
        """
        return self._initial_portfolio_plan_insights

    @initial_portfolio_plan_insights.setter
    def initial_portfolio_plan_insights(self, initial_portfolio_plan_insights):
        """Sets the initial_portfolio_plan_insights of this Recommendations.


        :param initial_portfolio_plan_insights: The initial_portfolio_plan_insights of this Recommendations.  # noqa: E501
        :type: PortfolioPlanInsights
        """

        self._initial_portfolio_plan_insights = initial_portfolio_plan_insights

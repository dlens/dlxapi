...
class Recommendations(object):
    ...
    def __init__(self, portfolio_plan_id=None, items=None, initial_portfolio_plan_insights=None, schedule_result_info=None, overconstrained_message=None):  # noqa: E501

...
class ProjectCreatedEvent(object):
    ...
    def __init__(self, portfolio_id=None, source_project_id=None, contributing_user_ids=None, name=None, is_draft=None, is_grouped=None, id=None, position=None, field_values=None, user_id=None, portfolio_plan=None, is_from_import=None):  # noqa: E501

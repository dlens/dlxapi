...
class CommentAddedEvent(object):
    ...
    def __init__(self, portfolio_id=None, id=None, project_name=None, user_id=None, project_id=None, value=None, portfolio_plan=None, _configuration=None):  # noqa: E501

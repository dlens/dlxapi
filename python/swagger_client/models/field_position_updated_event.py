...
class FieldPositionUpdatedEvent(object):
    ...
    def __init__(self, portfolio_id=None, name=None, id=None, position=None, field_type=None, previous_position=None, portfolio_plan=None, _check_required=True):  # noqa: E501

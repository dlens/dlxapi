...
class SpreadsheetReport(object):
    ...
    swagger_types = {
        ...
        'update_budgets': 'Budgets',
        'update_project_field_values_count': 'int',
        'update_field_data_values_count': 'int',
    ...
    attribute_map = {
        ...
        'update_field_data_values_count': 'updateFieldDataValuesCount',
    ...
    def __init__(self, portfolio_id=None, spreadsheet_id=None, sheet_name=None, new_projects=None, fields=None, new_fields=None, new_budgets=None, update_fields=None, update_budgets=None, update_project_field_values_count=None, update_field_data_values_count=None, new_budget_amounts_count=None, update_budget_amounts_count=None, update_time_periods_count=None, update_projects=None, warnings=None, import_type=None, _check_required=True):  # noqa: E501
        ...
        self._update_field_data_values_count = None
        ...
        if update_field_data_values_count is not None:
            self.update_field_data_values_count = update_field_data_values_count
    ...
    @property
    def update_field_data_values_count(self):
        """Gets the update_field_data_values_count of this SpreadsheetReport.  # noqa: E501


        :return: The update_field_data_values_count of this SpreadsheetReport.  # noqa: E501
        :rtype: int
        """
        return self._update_field_data_values_count

    @update_field_data_values_count.setter
    def update_field_data_values_count(self, update_field_data_values_count):
        """Sets the update_field_data_values_count of this SpreadsheetReport.


        :param update_field_data_values_count: The update_field_data_values_count of this SpreadsheetReport.  # noqa: E501
        :type: int
        """

        self._update_field_data_values_count = update_field_data_values_count

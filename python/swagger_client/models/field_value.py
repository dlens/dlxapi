...
class FieldValue(object):
    ...
    def __init__(self, field=None, project=None, value=None, numeric_value=None, boolean_value=None, numeric_values=None, values=None, time_period=None, details=None, created_at=None, modified_at=None):  # noqa: E501

...
class ActivityType(object):
    ...
    FIELDSPENDPLANPOSITIONUPDATEDEVENT = "FieldSpendPlanPositionUpdatedEvent"
    ...
    FIELDREQUIREMENTUPDATEDEVENT = "FieldRequirementUpdatedEvent"
    PORTFOLIOARCHIVEDEVENT = "PortfolioArchivedEvent"
    PORTFOLIOCREATEDEVENT = "PortfolioCreatedEvent"
    PORTFOLIOCOPIEDEVENT = "PortfolioCopiedEvent"
    ...
    PROJECTCATEGORYOPTIONADDEDEVENT = "ProjectCategoryOptionAddedEvent"
    PROJECTCATEGORYOPTIONREMOVEDEVENT = "ProjectCategoryOptionRemovedEvent"
    ...
    PORTFOLIOPLANDATAFIELDVALUESSYNCEDEVENT = "PortfolioPlanDataFieldValuesSyncedEvent"
    PROJECTSCOPIEDEVENT = "ProjectsCopiedEvent"
    ...
    BUDGETAMOUNTUPDATEDEVENT = "BudgetAmountUpdatedEvent"
    PLANBUDGETAMOUNTUPDATEDEVENT = "PlanBudgetAmountUpdatedEvent"
    PLANBUDGETCOPIEDEVENT = "PlanBudgetCopiedEvent"
    BUDGETCREATEDEVENT = "BudgetCreatedEvent"
    BUDGETNAMEUPDATEDEVENT = "BudgetNameUpdatedEvent"
    BUDGETDELETEDEVENT = "BudgetDeletedEvent"
    ...
    USEREMAILUPDATEDEVENT = "UserEmailUpdatedEvent"
    USERFIRSTNAMEUPDATEDEVENT = "UserFirstNameUpdatedEvent"
    USERLASTNAMEUPDATEDEVENT = "UserLastNameUpdatedEvent"
    ...
    PORTFOLIOISOVERALLRANKENABLEDUPDATEDEVENT = "PortfolioIsOverallRankEnabledUpdatedEvent"
    PORTFOLIOISPORTFOLIOOPENUPDATEDEVENT = "PortfolioIsPortfolioOpenUpdatedEvent"
    PORTFOLIOSHOWPORTFOLIOOPENINDICATORUPDATEDEVENT = "PortfolioShowPortfolioOpenIndicatorUpdatedEvent"
    PORTFOLIOSENDCONTRIBUTORSUBMISSIONEMAILSUPDATEDEVENT = "PortfolioSendContributorSubmissionEmailsUpdatedEvent"
    PORTFOLIOISCOSTADJUSTEDVALUESCOREENABLEDUPDATEDEVENT = "PortfolioIsCostAdjustedValueScoreEnabledUpdatedEvent"
    PORTFOLIOBUDGETTYPEUPDATEDEVENT = "PortfolioBudgetTypeUpdatedEvent"
    PORTFOLIOBUDGETOPTIONFIELDIDUPDATEDEVENT = "PortfolioBudgetOptionFieldIdUpdatedEvent"
    PORTFOLIOISBUDGETOPTIONSELECTEDUPDATEDEVENT = "PortfolioIsBudgetOptionSelectedUpdatedEvent"
    PORTFOLIOSTRATEGYNAVIGATORALGORITHMUPDATEDEVENT = "PortfolioStrategyNavigatorAlgorithmUpdatedEvent"
    PORTFOLIOISPRIORITYENABLEDUPDATEDEVENT = "PortfolioIsPriorityEnabledUpdatedEvent"
    PORTFOLIOISLOCATIONENABLEDUPDATEDEVENT = "PortfolioIsLocationEnabledUpdatedEvent"
    PORTFOLIOISAPPROVALSENABLEDUPDATEDEVENT = "PortfolioIsApprovalsEnabledUpdatedEvent"
    ...
    PORTFOLIOPORTFOLIOSTATEUPDATEDEVENT = "PortfolioPortfolioStateUpdatedEvent"
    ...
    BUDGETFIELDVALUEUPDATEDEVENT = "BudgetFieldValueUpdatedEvent"
    ...
    RECOMMENDATIONSAPPLIEDEVENT = "RecommendationsAppliedEvent"
    ...
    FIELDATTRIBUTESOPERANDSUPDATEDEVENT = "FieldAttributesOperandsUpdatedEvent"
    FIELDATTRIBUTESOPERATORUPDATEDEVENT = "FieldAttributesOperatorUpdatedEvent"
    FIELDRANKEDBASEDONSORTORDEREVENT = "FieldRankedBasedOnSortOrderEvent"
    FIELDATTRIBUTESDATAFORMATSNUMBERFORMATUPDATEDEVENT = "FieldAttributesDataFormatsNumberFormatUpdatedEvent"
    FIELDATTRIBUTESDATAFORMATSDATEFORMATUPDATEDEVENT = "FieldAttributesDataFormatsDateFormatUpdatedEvent"
    FIELDATTRIBUTESALLOWDUPLICATESUPDATEDEVENT = "FieldAttributesAllowDuplicatesUpdatedEvent"
    FIELDDATAUPDATEDEVENT = "FieldDataUpdatedEvent"
    FIELDDATADELETEDEVENT = "FieldDataDeletedEvent"
    ROLLUPSUBPORTFOLIOADDEDEVENT = "RollupSubPortfolioAddedEvent"
    PORTFOLIOSUMMARYSETTINGSUPDATEDEVENT = "PortfolioSummarySettingsUpdatedEvent"
    COSTTYPECREATEDEVENT = "CostTypeCreatedEvent"
    COSTTYPENAMEUPDATEDEVENT = "CostTypeNameUpdatedEvent"
    COSTTYPEDESCRIPTIONUPDATEDEVENT = "CostTypeDescriptionUpdatedEvent"
    COSTTYPETIMEPERIODTYPEUPDATEDEVENT = "CostTypeTimePeriodTypeUpdatedEvent"
    COSTTYPEISFORFUNDEDPROJECTSUPDATEDEVENT = "CostTypeIsForFundedProjectsUpdatedEvent"
    COSTTYPEATTRIBUTESOPERATORUPDATEDEVENT = "CostTypeAttributesOperatorUpdatedEvent"
    COSTTYPEATTRIBUTESOPERANDSUPDATEDEVENT = "CostTypeAttributesOperandsUpdatedEvent"
    COSTTYPEATTRIBUTESCELLCOLORSUPDATEDEVENT = "CostTypeAttributesCellColorsUpdatedEvent"
    COSTTYPEPOSITIONUPDATEDEVENT = "CostTypePositionUpdatedEvent"
    COSTTYPEDELETEDEVENT = "CostTypeDeletedEvent"
    PORTFOLIOTIMEPERIODUPDATEDEVENT = "PortfolioTimePeriodUpdatedEvent"
    PORTFOLIOCONTRIBUTORPERMISSIONSUPDATEDEVENT = "PortfolioContributorPermissionsUpdatedEvent"
    PORTFOLIOPLANUSERCOSTTYPEPERMISSIONSUPDATEDEVENT = "PortfolioPlanUserCostTypePermissionsUpdatedEvent"
    PRIORITIZATIONCREATEDEVENT = "PrioritizationCreatedEvent"
    PRIORITIZATIONUSERCREATEDEVENT = "PrioritizationUserCreatedEvent"
    PRIORITIZATIONNAMEUPDATEDEVENT = "PrioritizationNameUpdatedEvent"
    PRIORITIZATIONDESCRIPTIONUPDATEDEVENT = "PrioritizationDescriptionUpdatedEvent"
    PRIORITIZATIONISARCHIVEDUPDATEDEVENT = "PrioritizationIsArchivedUpdatedEvent"
    ACTIVITYNOTENOTEUPDATEDEVENT = "ActivityNoteNoteUpdatedEvent"
    REASSIGNEDCOSTBETWEENPROJECTSEVENT = "ReassignedCostBetweenProjectsEvent"
    PORTFOLIOPLANCALCULATEDVALUESUPDATEDEVENT = "PortfolioPlanCalculatedValuesUpdatedEvent"
    PRIORITIZATIONSCOREWEIGHTSAVEDEVENT = "PrioritizationScoreWeightSavedEvent"
    PRIORITIZATIONISPRIORITIESENABLEDUPDATEDEVENT = "PrioritizationIsPrioritiesEnabledUpdatedEvent"
    PRIORITIZATIONISRATINGSENABLEDUPDATEDEVENT = "PrioritizationIsRatingsEnabledUpdatedEvent"
    APPROVALCREATEDEVENT = "ApprovalCreatedEvent"
    APPROVALDELETEDEVENT = "ApprovalDeletedEvent"
    APPROVALNAMEUPDATEDEVENT = "ApprovalNameUpdatedEvent"
    APPROVALDESCRIPTIONUPDATEDEVENT = "ApprovalDescriptionUpdatedEvent"
    APPROVALISACTIVEUPDATEDEVENT = "ApprovalIsActiveUpdatedEvent"
    APPROVALISOPENUPDATEDEVENT = "ApprovalIsOpenUpdatedEvent"
    APPROVALAPPROVERUSERIDSUPDATEDEVENT = "ApprovalApproverUserIdsUpdatedEvent"
    APPROVALSELECTORSUPDATEDEVENT = "ApprovalSelectorsUpdatedEvent"
    APPROVALNEXTAPPROVALIDUPDATEDEVENT = "ApprovalNextApprovalIdUpdatedEvent"
    PROJECTCHANGECREATEDEVENT = "ProjectChangeCreatedEvent"
    PROJECTCHANGEUPDATEDEVENT = "ProjectChangeUpdatedEvent"
    PROJECTCHANGEDELETEDEVENT = "ProjectChangeDeletedEvent"
    PROJECTCHANGEAPPROVEDEVENT = "ProjectChangeApprovedEvent"
    PROJECTCHANGEREJECTEDEVENT = "ProjectChangeRejectedEvent"
    PROJECTCHANGEMOVEDEVENT = "ProjectChangeMovedEvent"
    PORTFOLIOMESSAGESCREATEDEVENT = "PortfolioMessagesCreatedEvent"
    PRIORITIZATIONPORTFOLIOSCORESUPDATEDEVENT = "PrioritizationPortfolioScoresUpdatedEvent"
    AGGREGATEDEVENT = "AggregatedEvent"
    FIELDATTRIBUTESDISPLAYTYPEUPDATEDEVENT = "FieldAttributesDisplayTypeUpdatedEvent"
    """
    Attributes:

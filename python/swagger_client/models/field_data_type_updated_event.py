...
class FieldDataTypeUpdatedEvent(object):
    ...
    def __init__(self, portfolio_id=None, previous_data_type=None, data_type=None, name=None, id=None, field_type=None, portfolio_plan=None, _check_required=True):  # noqa: E501

...
* [Update everything from an export](#update-everything-from-an-export)
...
## Update everything from an export
Given a schedule export, update statuses, start date, end date, allocations, and requests from an update to that spreadsheet.
